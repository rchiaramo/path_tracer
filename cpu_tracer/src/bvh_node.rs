...
mod test {
    ...
    #[test]
    fn make_tree() {
        let mut spheres = Vec::<Sphere>::with_capacity(5);

        spheres.push(Sphere::new(Vec3::new(0.0, 1.0, 0.0), 1.0, 1));

        spheres.push(Sphere::new(Vec3::new(-4.0, 1.0, 0.0), 1.0, 1));

        spheres.push(Sphere::new(Vec3::new(4.0, 1.0, 0.0), 1.0, 1));

        spheres.push(Sphere::new(Vec3::new(-8.0, 1.0, 0.0), 1.0, 1));

        spheres.push(Sphere::new(Vec3::new(8.0, 1.0, 0.0), 1.0, 1));

        let mut tree = BVHTree::new(5);
